                    ...
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="col-xl-12 input-group mb-3">
                          ...
                          <input id="alarm_cycles" class="form-control" type="text" name="alarm_cycles" placeholder="cycles" value="0" title="cycles">
                          <input id="alarm_hours" class="form-control" type="text" name="alarm_hours" placeholder="hours" value="0" title="hours">
                          <input id="alarm_calendar" class="form-control" type="text" name="alarm_calendar" placeholder=" Calendar" value="0">
                          <select id="alarm_period" class="form-control" name="alarm_period">
                            <option value="D">D</option>
                            <option value="M">M</option>
                            <option value="Y">Y</option>
                          </select>
                    ...
                    <div class="col-xl-12 pt">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-12 input-group mb-3">
                          ...
                          <input id="cum_cycles" class="form-control" type="text" name="cum_cycles" placeholder="cycles" value="0" title="cycles">
                          <input id="cum_hours" class="form-control" type="text" name="cum_hours" placeholder="hours" value="0" title="hours">
                        </div>
                        <div class="col-xl-12 input-group mb-3">
                          <div class="input-group-prepend">
                          ...
                          <input id="next_due_cycles" class="form-control" type="text" name="next_due_cycles" placeholder="cycles" value="" title="cycles" readonly>
                          <input id="next_due_hours" class="form-control" type="text" name="next_due_hours" placeholder="hours" value="" readonly title="hours">
