...
<body class="fixed-nav sticky-footer bg-dark landing" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url(); ?>">
      <img src="<?php echo base_url(); ?>images/logo3.png" alt="">
    </a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Aircrafts</span>
          </a>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Flights">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseFlights" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-plane"></i>
            <span class="nav-link-text">Flight Logs</span>
          </a>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Scheduled Maintenance</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
              <a href="<?php echo base_url(); ?>maintenance/apu_tasks">APU</a>
            </li>
            <li>
              <a href="<?php echo base_url(); ?>maintenance/components">Components</a>
            </li>
            <li>
              <a href="<?php echo base_url(); ?>maintenance/inspections">Inspections</a>
            </li>
            <li>
              <a href="<?php echo base_url(); ?>maintenance/oop_tasks">OOP</a>
            </li>
            <li>
              <a href="<?php echo base_url(); ?>maintenance/expired_tasks">Expired Tasks</a>
            </li>
          </ul>
        </li>
