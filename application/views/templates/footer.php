  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="aviaBtn btn" type="button" data-dismiss="modal">Cancel</button>
        <a class="aviaBtn btn btn-danger" href="<?php echo base_url('auth/logout'); ?>">Logout</a>
      </div>
    </div>
  </div>
</div>
...
<script src="<?php echo base_url(); ?>js/updates.js"></script>
</div>
</body>
</html>
