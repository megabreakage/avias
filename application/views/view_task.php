<form id="v_taskUpdate" action="<?php echo base_url("maintenance/add_task"); ?>" method="post">
  <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-sm table-bordered table-hover">
                  ...
                  <tbody id="freqScheduleDetails">
                    <?php foreach ($schedule_details as $detail): ?>
                      <tr>
                        <input id="v_schedule_details_id" type="hidden" name="" value="<?php echo $detail['schedule_details_id']; ?>">
              ...
              <div class="col-12">
                <div class="row">
                  <div class="col-md-12 input-group mb-3">
                    ...
                    <input id="v_life_limit_cycles" class="form-control" type="text" name="life_limit_cycles" placeholder="cycles" value="0" title="cycles">
                    <input id="v_life_limit_hours" class="form-control" type="text" name="life_limit_hours" placeholder="hours" value="0" title="hours">
                    <input id="v_life_limit_calendar" class="form-control" type="text" name="life_limit_calendar" placeholder=" Calendar" value="0" title="calendar time">
                  ...
                  <div class="col-md-12 input-group mb-3">
                    ...
                    <input id="v_alarm_cycles" class="form-control" type="text" name="alarm_cycles" placeholder="cycles" value="0" title="cycles" required>
                    <input id="v_alarm_hours" class="form-control" type="text" name="alarm_hours" placeholder="hours" value="0" title="hours" required>
                    <input id="v_alarm_calendar" class="form-control" type="text" name="alarm_calendar" placeholder=" Calendar" value="0" required>
              ...
              <div class="col-md-12 pt">
                ...
                <div class="row">
                  <div class="col-md-12 input-group mb-3">
                    ...
                    <input id="v_last_done_cycles"  class="form-control" type="text" name="last_done_cycles" placeholder="cycles" value="0" title="cycles" required>
                    <input id="v_last_done_hours"  class="form-control" type="text" name="last_done_hours" placeholder="hours" value="0" title="hours" required>
                    <input id="v_last_done_date"  class="form-control" type="date" name="last_done_date" placeholder="Date" title="date">
                  </div>
                  <div class="col-md-12 input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">Cumulative:</span>
                    </div>
                    <input id="v_cum_cycles" class="form-control" type="text" name="cum_cycles" placeholder="cycles" value="0" title="cycles" required>
                    <input id="v_cum_hours" class="form-control" type="text" name="cum_hours" placeholder="hours" value="0" title="hours" required>
                  </div>
                  <div class="col-md-12 input-group mb-3">
                    <div class="input-group-prepend">
                    ...
                    <input id="v_next_due_cycles" class="form-control" type="text" name="next_due_cycles" placeholder="cycles" value="" readonly title="Due cycles">
                    <input id="v_next_due_hours" class="form-control" type="text" name="next_due_hours" placeholder="hours" value="" readonly title="Due hours">
                    <input id="v_next_due_date" class="form-control" type="text" name="next_due_date" placeholder="Date" value="" readonly title="Due date">
                  </div>
