...
--
-- Host: localhost:3306
-- Generation Time: Jan 25, 2019 at 09:15 PM
...
--
ALTER TABLE `aircrafts`
  MODIFY `aircraft_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `ata_chapters`
  MODIFY `ata_chapter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `engines`
  MODIFY `engine_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `propellers`
  MODIFY `propeller_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
