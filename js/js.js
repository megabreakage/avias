...
$(document).ready(function(){
  ...
  // Search functions
    ...
    $("#cs_schedule_cat_id").change(function(){
      schedule_cat_id = { schedule_cat_id: $("#cs_schedule_cat_id").val() };
      $.ajax({
        url: 'cs_search_by_schedule_cat',
        method: 'post',
        dataType: 'json',
        data: schedule_cat_id,
        success: function(data){
          $("#tblComponents").empty();
          j = 1
          for (var i = 0; i < data.length; i++) {
    ...
    $("#cs_type_id").change(function(){
      schedule_type_id = { schedule_type_id: $("#cs_type_id").val() };
      $.ajax({
        url: 'cs_search_by_schedule_type',
        method: 'post',
        dataType: 'json',
    ...
    $("#cs_task_cat_id").change(function(){
      task_cat_id = { task_cat_id: $("#cs_task_cat_id").val() };
      $.ajax({
        url: 'cs_search_by_task_cat',
        method: 'post',
        dataType: 'json',
        data: task_cat_id,
        success: function(data){
